...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <main>
    ...
    <div class="container text-white font-text-bold">
  ...
  <div class="row">
  <div class="col-lg-4">
        <img src="images/woman.png" class="img-fluid rounded-circle" width="140" height="140">
        <h2>PRIYANKA SINGH</h2>
        <p>
        </p>
        <p><a class="btn btn-secondary" href="https://mail.google.com" role="button">piku7689@gmail.com>></a></p>
         </div>
  <div class="col-lg-4">
        <img src="images/man.png" class="img-fluid rounded-circle" width="140" height="140">
        <h2>SACHIN JHA</h2>
        <p>
        </p>
        <p><a class="btn btn-secondary" href="https://mail.google.com" role="button">sachinjha228@gmail.com>></a></p>
         </div>
    <div class="col-lg-4">
        <img src="images/man.png" class="img-fluid rounded-circle" width="140" height="140">
        <h2>MODASSIR MANJAR</h2>
        <p>
        </p>
        <p><a class="btn btn-secondary" href="https://mail.google.com" role="button">modassirmanjar290@gmail.com>></a></p>
         </div>
      <div class="col-lg-4">
        <img src="images/man.png" class="img-fluid rounded-circle" width="140" height="140">
        <h2>GOVIND GUPTA</h2>
        ...
        <p><a class="btn btn-secondary" href="https://mail.google.com" role="button">govindkg1997@gmail.com>></a></p>
         </div>
       <div class="col-lg-4">
        <img src="images/man.png" class="img-fluid rounded-circle" width="140" height="140">
        <h2>RISHI GUPTA</h2>
        ...
        <p><a class="btn btn-secondary" href="https://mail.google.com" role="button">gupta.rishi305@gmail.com>></a></p>
         </div>
      
       <div class="col-lg-4">
        <img src="images/man.png" class="img-fluid rounded-circle" width="140" height="140">
        <h2>VIKRANT CHAUDHARY</h2>
        <p>
        </p>
        <p><a class="btn btn-secondary" href="https://mail.google.com" role="button">iimtvikrant256@gmail.com>></a></p>
         </div>
        ...
        <p><a class="btn btn-secondary" href="https://mail.google.com" role="button">rehankhansiwani10@gmail.com>></a></p>
         </div>
  </div>
        <div class="container">  
      <div class="row">

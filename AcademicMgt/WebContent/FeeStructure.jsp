...
<title>Course+FeeStructure</title>
...
<header>
 ...
 <section class="jumbotron text-left">
    <div class="container">
      <h1 class="jumbotron-heading text-white">COURSES</h1>
      <p class="text-white">We Provide.Contact us for queries.</p>
      <p>
        <a href="#" class="btn btn-primary my-2"> Email Us for Query</a>
        <a href="Registration.jsp" class="btn btn-secondary my-2">Register</a>
      </p>
    </div>
  </section>
  ...
  <div class="row">
  <div class="col-lg-4">
        <img src="images/poly.jpg" class="img-fluid rounded-circle" width="140" height="140">
        <h2>Polytechnic </h2>
        <p>
        </p>
        <p><a class="btn btn-secondary" href="courseDetails.jsp" role="button">View Details>></a></p>
         </div>
  <div class="col-lg-4">
       <img src="images/technology.png" class="img-fluid rounded-circle" width="140" height="140">
        
        <h2 id="para">Bachelors in Technology </h2>
       
        <p><a class="btn btn-secondary" href="Btech.jsp" role="button">View Details>></a></p>
   </div>
    <div class="col-lg-4">
      <img src="images/accounts.jpg" class="img-fluid rounded-circle" width="140" height="140">
        <h2>Bachelors in <br>
        Commerce </h2>
        <p>
        </p>
       ...
       <div class="col-lg-4">
        <img src="images/pharmacy.jpg" class="img-fluid rounded-circle" width="140" height="140">
        <h2>Bachelors in<br> Pharmacy </h2>
        <p>
        </p>
        <p><a class="btn btn-secondary" href="courseDetails.jsp" role="button">View Details>></a></p>
      </div>
       <div class="col-lg-4">
             <img src="images/application.jpg" class="img-fluid rounded-circle" width="140" height="140">
        
        <h2>Bachelors in <br>Computer  <br> Application </h2>
        <p>
        </p>
        <p><a class="btn btn-secondary" href="courseDetails.jsp" role="button">View Details>></a></p>
      </div>
       ...
       <div class="col-lg-4">
        <img src="images/jour.jpg" class="img-fluid rounded-circle" width="140" height="140">
        <h2>Bachelors in <br>journalism   <br>and Mass <br> Communication  </h2>
        <p>
        </p>
        <p><a class="btn btn-secondary" href="courseDetails.jsp" role="button">View Details>></a></p>
      </div>
